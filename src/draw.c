...
/*   Updated: 2018/12/06 14:13:54 by dpalombo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		ft_pixel_color(t_fdf *fdf, t_bresenham val, \
t_vector v1, t_vector v2)
{
	...
	if (v1.color == v2.color)
		return (v1.color);
	dv = ft_dv(val, v1);
	r = (((int)((v1.color >> 16) & 255) + \
	(((int)((v2.color >> 16) & 255)) - ((int)((v1.color >> 16) & 255))) * dv));
	g = (((int)((v1.color >> 8) & 255) + \
	(((int)((v2.color >> 8) & 255)) - ((int)((v1.color >> 8) & 255))) * dv));
	b = (((int)(v1.color & 255) + \
	(((int)(v2.color & 255)) - ((int)(v1.color & 255))) * dv));
	color = r << 16 | g << 8 | b;
	if (color == DEFAULTC)
...
static void		ft_bresenham_else(t_fdf *fdf, t_bresenham val, \
t_vector v1, t_vector v2)
{
	val.e = val.dy;
...
void			ft_bresenham(t_fdf *fdf, t_vector v1, t_vector v2)
{
	...
	if ((val.e = val.dx) > val.dy)
		...
		{
			ft_pixel(fdf->img->data, v1.x, v1.y, \
			ft_pixel_color(fdf, val, v1, v2));
			v1.x += val.xi;
			val.e -= val.dy;
			if (val.e <= 0 && val.dy != 0)
			{
